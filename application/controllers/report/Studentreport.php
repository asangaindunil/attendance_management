...
class Studentreport extends BaseController
{
    /**
    ...
    function generatePdf()
    {
        ...
        $items = $this->cusreport->getstudentlist($fac,$start,$batch);
...
// add a page
        ...
        $pdf->SetXY(0, 40);
        $pdf->Cell(0, 0, 'Student List', 0, 1, 'C', 0, '', 0);
...
//        $pdf->Ln();
        ...
        $Header = array('Student ID', 'Faculty', 'Batch', 'Telephone');
